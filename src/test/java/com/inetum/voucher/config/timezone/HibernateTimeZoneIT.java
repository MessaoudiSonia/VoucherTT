package com.inetum.voucher.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.inetum.voucher.IntegrationTest;
import com.inetum.voucher.repository.timezone.DateTimeWrapper;
import com.inetum.voucher.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM inetum_date_time_wrapper where id=%d", fieldName, id);
    }
